...
<header class="fixed top-0 left-0 right-0 z-50 bg-amber-400/90 backdrop-blur-sm">
  ...
  <div class="mobile-menu hidden md:hidden bg-amber-400 w-full px-4 pb-4 shadow-lg">
    ...
    <a class="block py-3 text-black font-semibold border-b border-amber-500 hover:text-white transition" href="{{ route('menu') }}">Menu</a>
    <a class="block py-3 text-black font-semibold border-b border-amber-500 hover:text-white transition" href="{{ route('about') }}">À propos</a>
